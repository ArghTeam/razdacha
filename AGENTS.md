...
Есть один встроенный туннель-пул: он ротирует бесплатные ключи всех стран из источника
igareck ([ADR 0018](docs/decisions/0018-unified-pool.md)). Сервер сам берёт ключи,
