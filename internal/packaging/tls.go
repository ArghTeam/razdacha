...
//
// «Покрывает все нужные адреса» — это и есть условие перевыпуска при переходе в
// публичный режим: в SAN старого сертификата внешнего адреса нет, сам он там не
// появится, и сертификат выпускается заново уже на оба адреса.
